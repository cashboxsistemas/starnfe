...
Route::group(['prefix' => 'login'], function () {
    Log::info('Grupo de rotas /login acessado');
...
Route::middleware([
    ...
    Route::group(['prefix' => 'produtos'], function () {
        ...
        Route::post('/exportacaoBalancaFile', 'ProductController@exportacaoBalancaFile')->name('produtos.exportacaoBalancaFile');
    ...
    Route::group(['prefix' => 'vendas'], function () {
        ...
        Route::post('/importacao', 'VendaController@importStore')->name('vendas.importacao_store');
    ...
    Route::group(['prefix' => 'frenteCaixa'], function () {
        ...
        Route::get('/storeConfig', 'FrontBoxController@storeConfig')->name('frenteCaixa.getConfig');
    });
    ...
    Route::get('/produtos/exportacaoBalanca', 'ProductController@exportacaoBalanca')
        ->name('produtos.exportacaoBalanca');
    Route::post('/produtos/exportacaoBalancaFile', 'ProductController@exportacaoBalancaFile')
        ->name('produtos.exportacaoBalancaFile');
});

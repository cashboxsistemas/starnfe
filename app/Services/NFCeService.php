...
class NFCeService{
	...
	public function gerarNFCe($venda){
		...
		$stdResp->CNPJ = "05810477000156"; //CNPJ da pessoa jurídica responsável pelo sistema utilizado na emissão do documento fiscal eletrônico
		$stdResp->xContato= "Mizael"; //Nome da pessoa a ser contatada
		$stdResp->email ="mizakpiva@gmail.com"; //E-mail da pessoa jurídica a ser contatada
		$stdResp->fone = "48996895205"; //Telefone da pessoa jurídica/física a ser contatada
